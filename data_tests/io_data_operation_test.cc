...
#include "twister/compiler/parser/select_stmt.pb.h"
#include "twister/io/io_test_helper.h"
#include "twister/io/pb_assembler.h"
#include "twister/io/table_builder.cc"
...
#include "twister/utils/create_table_tool.h"
#include "twister/utils/filename_tool.h"

DEFINE_int64(pb_record_number, 1000, "record number to generate PB data");
DECLARE_string(twister_create_table_tool);
...
TEST_F(IOTest, MapReduceOperationValidate) {
    FLAGS_twister_create_table_tool = "../../../utils/create_table_mapreduce";
    // Construct pb data of recordio format
