...
#include "twister/io/history_info_io.h"
...
bool HistoryInfoWriter::Reset(File *file) {
    DCHECK(file != NULL);
    m_file = file;
    return true;
}
...
bool HistoryInfoWriter::WriteRecord(const StringPiece& data) {
...
bool HistoryInfoReader::Reset(File *file) {
    DCHECK(file != NULL);
    m_file = file;
...
bool HistoryInfoReader::ReadRecord(StringPiece *data) {
