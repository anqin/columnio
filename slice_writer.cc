...
#include "twister/io/slice_writer.h"
...
SliceWriter::SliceWriter() : m_buffer(new char[FLAGS_twister_tablet_file_size]) {
...
void SliceWriter::SetTabletWriter(TabletWriter *writer) {
    ...
    m_tablet_writer->SetBuffer(m_buffer, FLAGS_twister_tablet_file_size);
}
